<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BMButtonSearch.aspx.cs"
    Inherits="PayPalAPISample.APICalls.BMButtonSearch" %>
    ...
    <div id="wrapper">
        <div id="header">
            <h3>
                BMButtonSearch</h3>
            <div id="apidetails">
                Search previously created "Web Payment Standard" buttons.</div>
        </div>
            ...
            <div id="request_form">
                ...
                <div class="param_value">
                    <div id="endDateField" style="display: none;">
                        <asp:Calendar ID="calEndDate" OnSelectionChanged="calDate_SelectionChanged" runat="server" />
                    </div>
