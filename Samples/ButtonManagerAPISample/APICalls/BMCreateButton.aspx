<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BMCreateButton.aspx.cs"
    Inherits="PayPalAPISample.APICalls.BMCreateButton" %>
    ...
    <div id="wrapper">
        <div id="header">
            <h3>
                BMCreateButton</h3>
            <div id="apidetails">
                Create a Website Payments Standard button. You an create either a button that is
                hosted on PayPal or a non-hosted button.</div>
        </div>
