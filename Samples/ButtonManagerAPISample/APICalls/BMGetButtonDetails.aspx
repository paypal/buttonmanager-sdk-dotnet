<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BMGetButtonDetails.aspx.cs"
    Inherits="PayPalAPISample.APICalls.BMGetButtonDetails" %>
...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            <h3>
                BMGetButtonDetails</h3>
            <div id="apidetails">
                Obtain information about a hosted Website Payments Standard button.</div>
        </div>
