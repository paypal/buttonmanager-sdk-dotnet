...
<body>
    <div id="wrapper">
        ...
        <div class="section_header">
            Error messages</div>
        <div class="note">
            Investigate the response object for further error information</div>
        <ul>
            <%
        ...
        <%
            ...
            {%>
        <div>
            This API involves a web flow. You must now redirect your user to
            <%=redirectURL%>
            <br />
            Please click <a href="<%=redirectURL%>">here</a> to try the flow.</div>
        <%} %>
        <div class="section_header">
            Key values from response</div>
        <div class="note">
