<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs" Inherits="ButtonManagerAPISample.Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Button Manager SDK - API Samples - Home page</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <h2>
                Button Manager SDK - API Samples</h2>
            <table>
                <tr>
                    <td>
                        <ul>
